import 'package:exemplo_geolocator/clime_service.dart';
...
class _LocationScreenState extends State<LocationScreen> {
  ...
  //* pegar a localização do dispositivo
  void _getLocation() async {
    // verificar se o serviço de GPS está habilitado
    bool serviceEnable = await Geolocator.isLocationServiceEnabled();
    if (!serviceEnable) {
      locationMessage = "Serviço de localização está desabilitado";
      return;
    }
    ...
    if (permission == LocationPermission.denied) {
      // solicitar a liberação do uso do GPS
